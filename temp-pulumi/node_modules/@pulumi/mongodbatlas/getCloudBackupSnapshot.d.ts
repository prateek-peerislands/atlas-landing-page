 ...
 * ```
 */
export declare function getCloudBackupSnapshotOutput(args: GetCloudBackupSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudBackupSnapshotResult>;
/**
 * A collection of arguments for invoking getCloudBackupSnapshot.
 */

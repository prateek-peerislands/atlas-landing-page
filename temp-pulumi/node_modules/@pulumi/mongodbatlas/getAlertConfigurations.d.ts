 ...
 * > **NOTE:** Groups and projects are synonymous terms. You may find groupId in the official documentation.
 */
export declare function getAlertConfigurationsOutput(args: GetAlertConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertConfigurationsResult>;
/**
 * A collection of arguments for invoking getAlertConfigurations.
 */

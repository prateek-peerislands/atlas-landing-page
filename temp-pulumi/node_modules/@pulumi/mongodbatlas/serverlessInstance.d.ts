...
export declare class ServerlessInstance extends pulumi.CustomResource {
     ...
     */
    readonly connectionStringsPrivateEndpointSrvs: pulumi.Output<string[]>;
    /**
     ...
     * @deprecated This parameter is deprecated and will be removed in March 2025. For more details see https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/serverless-shared-migration-guide.
     */
    readonly continuousBackupEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.ServerlessInstanceTag[] | undefined>;
    /**

 ...
 * ```
 */
export declare function getProjectInvitationOutput(args: GetProjectInvitationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProjectInvitationResult>;
/**
 * A collection of arguments for invoking getProjectInvitation.
 */

...
export declare class PrivateEndpointRegionalMode extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateEndpointRegionalModeState, opts?: pulumi.CustomResourceOptions): PrivateEndpointRegionalMode;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrivateEndpointRegionalMode;
    /**

 ...
 * > **IMPORTANT:** In order to use AWS Security Group(s) VPC Peering must be enabled like in the above example.
 */
export declare function getProjectIpAccessListOutput(args: GetProjectIpAccessListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProjectIpAccessListResult>;
/**
 * A collection of arguments for invoking getProjectIpAccessList.
 */

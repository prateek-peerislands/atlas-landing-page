 ...
 * ```
 */
export declare function getFederatedQueryLimitOutput(args: GetFederatedQueryLimitOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFederatedQueryLimitResult>;
/**
 * A collection of arguments for invoking getFederatedQueryLimit.
 */

 ...
 * ```
 */
export declare function getStreamAccountDetails(args: GetStreamAccountDetailsArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamAccountDetailsResult>;
/**
 ...
 * ```
 */
export declare function getStreamAccountDetailsOutput(args: GetStreamAccountDetailsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamAccountDetailsResult>;
/**
 * A collection of arguments for invoking getStreamAccountDetails.
 */

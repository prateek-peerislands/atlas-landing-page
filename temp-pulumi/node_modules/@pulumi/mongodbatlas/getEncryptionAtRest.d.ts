 ...
 * ```
 */
export declare function getEncryptionAtRestOutput(args: GetEncryptionAtRestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEncryptionAtRestResult>;
/**
 * A collection of arguments for invoking getEncryptionAtRest.
 */

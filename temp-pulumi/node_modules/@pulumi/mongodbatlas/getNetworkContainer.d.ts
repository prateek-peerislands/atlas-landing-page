 ...
 * ```
 */
export declare function getNetworkContainerOutput(args: GetNetworkContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkContainerResult>;
/**
 * A collection of arguments for invoking getNetworkContainer.
 */

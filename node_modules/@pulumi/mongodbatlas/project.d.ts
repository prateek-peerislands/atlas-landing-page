...
export declare class Project extends pulumi.CustomResource {
     ...
     */
    readonly ipAddresses: pulumi.Output<outputs.ProjectIpAddresses>;
    /**
     ...
     */
    readonly isExtendedStorageSizesEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isSlowOperationThresholdingEnabled: pulumi.Output<boolean>;
    readonly limits: pulumi.Output<outputs.ProjectLimit[] | undefined>;
    /**
     ...
     */
    readonly regionUsageRestrictions: pulumi.Output<string>;
    /**

...
export declare class FederatedSettingsIdentityProvider extends pulumi.CustomResource {
     ...
     * - HTTP REDIRECT
     */
    readonly requestBinding: pulumi.Output<string | undefined>;
    /**
     * Scopes that MongoDB applications will request from the authorization endpoint used for OIDC IdPs.
     */
    readonly requestedScopes: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly ssoDebugEnabled: pulumi.Output<boolean | undefined>;
    /**

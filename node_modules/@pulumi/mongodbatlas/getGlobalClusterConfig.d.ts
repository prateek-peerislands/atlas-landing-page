...
export interface GetGlobalClusterConfigResult {
     ...
     */
    readonly customZoneMappingZoneId: {
        [key: string]: string;
    };
    /**
 ...
 * ```
 */
export declare function getGlobalClusterConfigOutput(args: GetGlobalClusterConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGlobalClusterConfigResult>;
/**
 * A collection of arguments for invoking getGlobalClusterConfig.
 */

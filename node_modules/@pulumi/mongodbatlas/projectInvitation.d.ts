 ...
 * ```
 */
export declare class ProjectInvitation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectInvitationState, opts?: pulumi.CustomResourceOptions): ProjectInvitation;
    /**
     * Returns true if the given object is an instance of ProjectInvitation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectInvitation;
    /**

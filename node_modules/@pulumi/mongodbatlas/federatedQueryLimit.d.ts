 ...
 */
export declare class FederatedQueryLimit extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedQueryLimitState, opts?: pulumi.CustomResourceOptions): FederatedQueryLimit;
    /**
     * Returns true if the given object is an instance of FederatedQueryLimit.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FederatedQueryLimit;
    /**
     * Amount that indicates the current usage of the limit.
     */
    readonly currentUsage: pulumi.Output<number>;
    /**
     * Default value of the limit.
     * * `lastModifiedDate` - Only used for Data Federation limits. Timestamp that indicates when this usage limit was last modified. This field uses the ISO 8601 timestamp format in UTC.
     * * `maximumLimit` - Maximum value of the limit.
     */
    readonly defaultLimit: pulumi.Output<number | undefined>;
     ...
     */
    readonly limitName: pulumi.Output<string>;
    readonly maximumLimit: pulumi.Output<number | undefined>;
    /**

 ...
 * - Setup private connection to a MongoDB Atlas Cluster with AWS VPC
 */
export declare function getPrivateLinkEndpointOutput(args: GetPrivateLinkEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateLinkEndpointResult>;
/**
 * A collection of arguments for invoking getPrivateLinkEndpoint.
 */

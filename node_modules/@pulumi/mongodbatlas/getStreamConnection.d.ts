 ...
 * ```
 */
export declare function getStreamConnectionOutput(args: GetStreamConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamConnectionResult>;
/**
 * A collection of arguments for invoking getStreamConnection.
 */

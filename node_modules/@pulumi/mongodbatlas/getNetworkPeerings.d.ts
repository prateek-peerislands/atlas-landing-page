 ...
 * ```
 */
export declare function getNetworkPeeringsOutput(args: GetNetworkPeeringsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkPeeringsResult>;
/**
 * A collection of arguments for invoking getNetworkPeerings.
 */

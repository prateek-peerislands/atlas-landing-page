...
export declare class ClusterOutageSimulation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterOutageSimulationState, opts?: pulumi.CustomResourceOptions): ClusterOutageSimulation;
    /**
     * Returns true if the given object is an instance of ClusterOutageSimulation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClusterOutageSimulation;
    /**
     ...
     */
    readonly outageFilters: pulumi.Output<outputs.ClusterOutageSimulationOutageFilter[]>;
    /**
     ...
     */
    readonly simulationId: pulumi.Output<string>;
    /**
     * Date and time when MongoDB Cloud started the regional outage simulation.
     */
    readonly startRequestDate: pulumi.Output<string>;
    /**
